...
/**
 * History & performance only. Live positions and account management now live in
 * the dedicated Trades tab — this screen keeps the calendar, per-day trade log,
 * notes, and shortcuts to Analytics / Portfolio.
 */
